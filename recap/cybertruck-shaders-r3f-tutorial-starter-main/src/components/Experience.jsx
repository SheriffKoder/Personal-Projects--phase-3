...
i want to add the lights to the earth, pc, 
add position to earth 2


we will have
earth with animated up text
navigation js mastery

laptop open on scroll
with reflective materials
tech also comes up on scroll with fadein

thus you should start working bit by bit
