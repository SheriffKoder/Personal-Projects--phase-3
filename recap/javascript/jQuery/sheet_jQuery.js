...
$(function(){
    ...
    //or
    //.add //adds elements to the current selection so ul becomes "ul li" ?
    $("ul").add("li").css("background-color", "red");
...
//put $(this) in the animation callback function
...
////Delegated events (new elements have events)
/*
...
////know what key pressed on keydown and do something with it
/*
...
//getJSON .then, iterate on data, .catch
/*
