            ...
            <div className="z-[6] flex items-center justify-center">
                ...
                ">
                    <div className="flex w-full">
                        ...
                        className="ml-auto bg-theme-text-brighter opacity-80 hover:opacity-100 dark:opacity-100 dark:bg-[#912642] dark:hover:bg-[#9f2545] h-5 w-5 rounded-[6px] text-white flex items-center justify-center">
                    ...
                    <form className=" mt-2 flex flex-col items-center w-full gap-4">
                        ...
                        <div className="w-[80%] flex">
                            <span className="ml-auto text-sm hover:text-[#d33660]">forgot password ?</span>
                        </div>
