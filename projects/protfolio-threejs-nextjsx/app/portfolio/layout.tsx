...
export default function Layout({
    ...
    // console.log(path);
    // console.log(isCustomComponent);

    return (
  
       
        <section className={`min-w-full  max-w-[1600px] mx-auto flex flex-col 
        min-h-full ambientBackground relative pt-[6rem]'}`}>
 
        {/* if the url is for a custom component, do not display the 3d-buttons, etc. */}
        {!isCustomComponent && (
          <>
            {/* button 3d models*/}
