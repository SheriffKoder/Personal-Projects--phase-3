                              ...
                              <div className="flex-1 flex flex-col py-2 px-2">
                                  ...
                                  <div className="flex flex-row gap-2 flex-wrap mt-auto">
                                    ...
                                    project.link && (
                                      ...
                                      `}>
                                        <a href={project.link} className="gradient_text_1 w-full h-full flex flex-row gap-[0.4rem]" target="_blank">
                                          {
                                          project.type === "site" && ("See live")
                                          }
                                          {
                                          project.type === "page" && ("See live")
                                          }
