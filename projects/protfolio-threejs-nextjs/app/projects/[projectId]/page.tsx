                        ...
                        <div className="order-1 flex flex-col gap-4 text-[calc(1rem+0.25vw)]">
                            ...
                            <div className="flex flex-col gap-2 flex-wrap md1:flex-row">
                                ...
                                currentProject.link && (
                                    ...
                                    `}>
                                        <a href={currentProject.link} className="gradient_text_1 w-full flex flex-row gap-[0.4rem]" target="_blank">
                                        {
                                        currentProject.type === "site" && ("See live")
                                        }
                                        {
                                        currentProject.type === "page" && ("See live")
                                        }
