...
const ResumeOverlay = () => {
  ...
  return (
    ...
    overflow-hidden bg-[rgba(2,8,18,0.79)]">
        <div className="w-[100vw] h-[0px]
        hidden flex-col items-center justify-center  overflow-hidden"
        id="resumeOverlay">
        
            <div className="w-[400px] flex flex-col items-center justify-center gap-8 relative">
                ...
                <div className="absolute bottom-[-2rem] cursor-pointer" onClick={hideResumeOverlay}>
                    close
                </div>
            </div>
        </div>
