    ...
    <div className="relative" id="homeTech_container">
      ...
      >
        ...
        ref={projectDescription}>
              ...
              <h2 className="font-semibold text-[min(1em,1.5rem)] flex flex-row items-center">
              ...
              <div className="my-2 flex flex-row gap-2">
                ...
                {projects[currentProject].link && (
                  <Link href={projects[currentProject].link} target="_blank"
        ...
        id="homeTech_models">
          ...
          <div className="relative flex items-center justify-center w-full h-full">
            ...
            <div style={{backgroundImage: `${myImage}, ${myColor}`, backgroundBlendMode: blendMode}}
              ...
              <button aria-label="zoom in" className="2xl:ml-[17.5rem] rounded-[5px] h-8 w-8 bg-black 
