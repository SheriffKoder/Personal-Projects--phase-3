            ...
            <div className="flex flex-col md2:flex-row gap-8 px-4 md2:items-start md2:justify-between">
                ...
                text-[min(1rem,calc(0.75rem+0.5vw))] max-w-[600px] mx-auto md2:mx-0 md2:max-w-full">
                    ...
                    <p className="mt-4">
                        ...
                        where I learnt the importance of client satisfaction which is a result of adding value and assisting clients achieve their goals.
                        ...
                        And to work in a field where it's challenges take me <span className="gr">further</span> in the <span className="gr">development</span> of the skills I would like to learn and master.
                        <br/>
                        <br/>
