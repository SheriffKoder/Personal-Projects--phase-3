...
const {buildSchema: LoginSchema} = require("graphql");
...
module.exports = LoginSchema(`
    ...
    type RootMutation {
        signUp(userInput: UserSignUpInputType ): UserResolverReturn!
    }

    type RootQuery {
        login(userInput: UserLoginInputType ) : UserResolverReturn!
    }
