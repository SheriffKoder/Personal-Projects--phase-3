...
exports.editCar = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (currentCar) {
            ...
            let imageUrl = currentCar.image;
            if (req.file)
                imageUrl = req.file.path;
            if (imageUrl !== currentCar.image)
...
exports.deleteCar = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!currentCar) {
            ...
            //     user.save();
            // }
            // await UserModel.updateOne({_id: req.userId.toString()}, {"$pull": { "cars": { _id: _id } } }).exec();
            // if (user) user.save();
            // const test = await UserModel.findOneAndUpdate({_id: req.userId.toString()}, {$pull: {alerts: {_id: _id}}}, function(err:any, data:any){
